...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_titulo.setGeometry(QtCore.QRect(320, 40, 241, 51))
        ...
        self.btn_ingresar.setGeometry(QtCore.QRect(350, 310, 111, 31))
        self.btn_ingresar.setObjectName("btn_ingresar")
        self.pushButton_3 = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(350, 350, 111, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Crear cuenta"))
